window.onload = () => {
    ...
    function changePath(e) {
        ...
        if (e.target.innerText == "Api Root") window.location.replace('https://web2-course-project-api-wh-wheirstrate.herokuapp.com/');
    }

    async function fetchAndLoadData() {
        let htmlDbString = "";
        const resp = await fetch('https://web2-course-project-api-wh.herokuapp.com/api/routes');
    ...
    async function submitForm() {
        ...
        await fetch('https://web2-course-project-api-wh.herokuapp.com/api/routes', {
            method: 'POST',
            headers: {
